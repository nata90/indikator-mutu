...
class Unit extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama_unit, inisial', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_unit, nama_unit, inisial', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'satkers' => array(self::HAS_MANY, 'Satker', 'id_unit'),
		);
	}
	...
	public static function getListUnit(){
		$data = CHtml::listData(Unit::model()->findAll(), 'id_unit', 'nama_unit');
		return $data; 
	}
}
